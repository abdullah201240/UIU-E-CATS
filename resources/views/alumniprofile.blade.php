...
<div class="container">
	<div class="profile-main">
		<div class="profile-container">
			<img src="images/{{ $da->cover }}" height="400px" width="100%">
			<div class="profile-container-inner">
				<img src="images/{{ $da->image }}" class="profile-pic">
				<h1>{{ $da->name }}</h1>
				...
				<div class="profile-btn">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="alumnieditprofile" style="background-color: #045be6; color: white;"><button id="editProfileBtn" class="button" style="background-color: #045be6;
  color: white;
  padding: 5px 10px;
  border: none;
  border-radius: 4px;
  cursor: pointer;
  font-size: 16px;">Edit Profile</button></a>
  ...
  <h2>About</h2>
  <p class="description-text">{{ $da->intro}}</p>
...
seeMoreLink.addEventListener('click', (event) => {
  ...
  seeMoreLink.textContent = descriptionText.classList.contains('show-more') ? 'See less' : 'See more...';
      ...
      <div class="profile-description">
  <h2>Experience &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button id="myBtn" class="add-experience-btn"><img src="images/plus.png" style="height: 15px;width: 15px;"></button></h2>
<div id="myModal" class="modal">
  ...
  margin: 0 auto;">
    ...
    <label for="company-name" style="color: black;">Company Name</label><br>
    <input type="text" id="company-name" name="company-name" style="height: 30px;width: 100%;">

    <label for="job-title" style="color: black;">Job Title</label>
    <input type="text" id="job-title" name="job-title" style="height: 30px;width: 100%;">

    <label for="employment-type" style="color: black;">Employment Type</label>
    <select id="employment-type" name="employment-type" style="height: 30px;width: 100%;">
    ...
    <textarea id="description" name="description" style="height: 60px;width: 100%;"></textarea>
    <br>
...
<div class="popup-form-container hidden">
  <form action="alumniaddexprience" method="post" >
    @csrf
...
submitBtn.addEventListener('click', (e) => {
  ...
  <div id="popupForm">
    ...
    <h2 style="color: #045be6;">Add Your Education Details</h2>
    <form action="/alumnieducation" method="post" enctype="multipart/form">
        @csrf
      <label for="name">Instititude Name</label>
      <input type="text" id="name" name="name" required><br>
      <label for="email">Degree</label>
      <input type="text" id="email" name="degree" required><br>
        <label for="name">Year of Passing</label>
      <input type="text" id="name" name="year" required><br>
  ...
  <div id="popup-content">
    <center>
      <section class="post" style="margin-left: 50%; margin-right: 50%;">
          ...
          <form action="alumniaddpost"  method="post" enctype="multipart/form-data">
            @csrf
            <div class="content">
              <img src="images/{{ $da->image }}" alt="logo" style="    overflow-clip-margin: content-box;
    ...
    margin-right: 10px;">
            ...
            @endforeach
            <textarea placeholder="What's on your mind?" spellcheck="false" name="postText" required></textarea>
