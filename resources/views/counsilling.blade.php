...
<body>
    <main class="table">
        <section class="table__header">
            <h1>All Booking Counselling</h1>
            <div class="input-group">
                <input type="search" placeholder="Search Data...">
                <img src="images/search.png" alt="">
            </div>
             <div >
               <a href="/studentaddcounsilling"> <button type="button" class="btn btn-success">Add Counselling</button></a>
                ...
                <thead>
                 ...
                 <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$da->states}} </td>
                        <td>{{$da->comment}} </td>
<td>                        <a href='/deletecounsling/{{$da->id}}'><button type="button" class="btn btn-danger">Delete</button></a> </td>
