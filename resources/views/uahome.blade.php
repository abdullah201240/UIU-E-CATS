...
<body>
   ...
   <div class="container">
        <form id="form" action="" method="post">
            @csrf
            <h4>We are going to assign "UA" for the following courses.  You must have an "A" grade in the applied course and CGPA 3.70 If you are interested then please select courses you want to apply.....</h4>
            <br><br>



            <div class="input-control">
                <label for="cn"><h5>Select from options</h5></label>
    ...
    <main class="table">
        <section class="table__header">
            <h1>All Applied Course & Section List for UA</h1>
                ...
                @foreach ( $data1 as $da1 )
                 ...
                 <tbody>
                    <tr>
                        ...
                        <td>
                           <a href="/deleteua/{{$da1->id}}"> <button type="button" class="btn btn-danger">Remove</button></a>
                        </td>
