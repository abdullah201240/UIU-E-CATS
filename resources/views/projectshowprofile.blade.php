...
@foreach($data as $da)
      <div class="box">
         ...
         <div class="content">
           ...
           <a href="{{$da->project_link}}"> <p>Project Link</p></a>
            <a href = "projectshowedit/{{$da->project_id}}" > <button class= "linkInButton"> Edit </button> </a>
            <p>{{$da->project_dis}}</p>
            <!--<a href="#" class="btn">Add Prize</a>-->
            <div class="icons">
               
               <span> <i class="fas fa-user"></i> by {{$da->tn}}</span>
            </div>
         </div>
      </div>
