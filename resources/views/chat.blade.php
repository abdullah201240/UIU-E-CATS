...
<body>
  ...
  <nav class="navbar">
    ...
    <div class="navbar-center">
      <ul>
        <li><a href="newsfeed.php" class="active-link"><img src="images/home.png"> <span>Home</span></a></li>
...
<!--chats -->
      <div class="chat-list">
       @foreach ( $data as $da )
        ...
        <div class="chat-box">
          <div class="img-box">
            <img class="img-cover" src="images/{{$da->timage}}" alt="">
          </div>
          <div class="chat-details">
            <div class="text-head">
              <a href="indivisual_chat/{{$da->tid}}"> <h4>{{$da->tname}}</h4></a>

            </div>
            <div class="text-head">
                <a href="chatify"> <h4>{{$da->tname}}</h4></a>
